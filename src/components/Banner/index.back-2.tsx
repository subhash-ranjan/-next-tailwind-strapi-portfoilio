...
const Index = () => {
    ...
    return (
        <div className="relative pt-[120px] lg:pt-[150px] pb-[110px] bg-white w-[100vw] px-20">
                    ...
                    <div className="w-full lg:w-5/12 px-4">
                        <div className="hero-content">
                            ...
                            <ul className="flex flex-wrap items-center">
                                <li>
                                    <a
                                        ...
                                        className=" py-4 px-6 sm:px-10 lg:px-8 xl:px-10 inline-flex items-center justify-center text-center text-white text-base bg-primary hover:bg-opacity-90 font-normal rounded-lg "
                                    >
                                        Get Started
                                    </a>
                                </li>
                                <li>
                                    <a
                                        href="javascript:void(0)"
                                        className=" py-4 px-6 sm:px-10 lg:px-8 xl:px-10 inline-flex items-center justify-center text-center text-base font-normal text-body-color hover:text-primary "
                                    >
                                        <span className="mr-2">
                                            <svg
                                                width="22"
                            ...
                            <div className="clients pt-16">
                                <h6 className=" font-normal text-xs flex items-center text-body-color mb-2 ">
                                    Some Of Our Clients
